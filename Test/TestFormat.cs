...
namespace Test
{
    ...
    public class TestFormat
    {
        ...
        [TestMethod]
        public void TestMethod_FormatterShort()
        {
            string testMessage = "Message #1 is received.";
            string expectedStr = "Message #1.\r\n";

            string actualStr = MobilePhoneProjLab2WinForm.Form1.SMSProvider_FormatterShort(testMessage);
            Assert.AreEqual(expectedStr, actualStr);
